...
> Building practical systems with clean architecture, secure APIs, and real-world impact.

</div>

### 🌾 GoviyaNet · Farm-to-Table Platform

Distributed farm-to-table platform connecting farmers, sellers, and customers via microservices.

**Built with:** `Spring Boot` `Spring Cloud` `Spring Security` `MySQL` `ActiveMQ`

[![View GoviyaNet](https://img.shields.io/badge/VIEW_PROJECT-9B7FFF?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Hasitha-Sandaruwan-Silva/GoviyaNet) [![Stars](https://img.shields.io/github/stars/Hasitha-Sandaruwan-Silva/GoviyaNet?style=flat-square&label=stars&color=9B7FFF)](https://github.com/Hasitha-Sandaruwan-Silva/GoviyaNet/stargazers)

---

### 🎨 GoviyaNet Frontend · Product Experience

Next.js frontend for the GoviyaNet ecosystem — product discovery and transactions.

**Built with:** `Next.js` `React` `TypeScript` `Tailwind CSS`

[![View Frontend](https://img.shields.io/badge/VIEW_PROJECT-9B7FFF?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Hasitha-Sandaruwan-Silva/GoviyaNet-Frontend) [![Stars](https://img.shields.io/github/stars/Hasitha-Sandaruwan-Silva/GoviyaNet-Frontend?style=flat-square&label=stars&color=9B7FFF)](https://github.com/Hasitha-Sandaruwan-Silva/GoviyaNet-Frontend/stargazers)

---

### 🏨 Mahameruwan Project · Hotel Management System

Multi-role hotel management system with role-based workflows and REST APIs.

**Built with:** `Django REST` `Next.js 14` `JWT` `Role-Based Access`

[![View Mahameruwan](https://img.shields.io/badge/VIEW_PROJECT-9B7FFF?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Hasitha-Sandaruwan-Silva/Mahameruwan_Project) [![Stars](https://img.shields.io/github/stars/Hasitha-Sandaruwan-Silva/Mahameruwan_Project?style=flat-square&label=stars&color=9B7FFF)](https://github.com/Hasitha-Sandaruwan-Silva/Mahameruwan_Project/stargazers)

---

### 📊 VegiTrack LK · Price Prediction Research

ML project on local vegetable price patterns and market predictions.
