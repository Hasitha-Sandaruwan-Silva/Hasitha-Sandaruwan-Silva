...
- 🏨 Developing **Mahameruwa** — a multi-role hotel management system using **Django REST + Next.js 14**
...
A distributed farm-to-table platform connecting farmers, sellers, and customers through a scalable microservices architecture.
...
The user-facing experience for the GoviyaNet ecosystem, designed around simple discovery and smooth agricultural product transactions.
...
A multi-role hotel management system exploring role-based workflows, REST APIs, and responsive operational dashboards.
...
A machine-learning project investigating local vegetable price patterns and data-driven market predictions.
...
<div align="center">
<img width="98%" src="https://ghchart.rshah.org/39d353/Hasitha-Sandaruwan-Silva" alt="Hasitha's GitHub contribution calendar" />
</div>
